                ...
                <div className="">
                    ...
                    <section className="relative w-full h-[580px] sm:h-[451px] overflow-hidden">
                        ...
                        >
                            ...
                            <motion.div
                                className="bg-[#173366] lato-400 text-left w-[450px] h-[350px] sm:w-[706px] sm:h-[351px] text-[14px] leading-relaxed opacity-90 sm:text-[16px] md:text-[20px] pl-4 pt-2 pb-4 pr-4 md:pl-24 lg:pl-28 sm:pt-2 sm:pb-4 sm:pr-12 mb-12 sm:mb-8"
