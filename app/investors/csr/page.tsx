                ...
                <section className="max-w-6xl mx-auto px-4 sm:px-12 md:px-20 lg:px-28 py-8">
                    ...
                    <div className="bg-white">
                        {csrAnnualActionPlans.map((item, idx) => {
                            const stripe =
                                idx % 2 === 0 ? "bg-[#F8F8F8]" : "bg-white"; // subtle striping

                            return (
                                <div
                                    key={item.href}
                                    className={`bg-[#F8F8F8] border-t-[2px] border-white px-6 py-4`}
                                >
                                    <Link
                                        href={item.href}
                                        target="_blank"
                                        className="block text-center text-[12px] sm:text-[14px] text-[#000000] lato-400 underline break-all"
                                    >
                                        {item.href}
                                    </Link>
                                </div>
