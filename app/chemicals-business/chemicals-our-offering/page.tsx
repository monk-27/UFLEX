...
export default function ProductsPage() {
  ...
  const productsData: Record<string, any> = {
    ...
    "water-based-adhesives": {
      ...
      overview: "Water-based adhesives provide strong bonding with low environmental impact, ideal for food-safe and sustainable packaging applications.",
      sections: [
        { name: "FLEXBOND FP DRY LAM F2F AEM 36 P",image: "/images/chemicals/1.png", description: "A waterborne acrylic adhesive designed for use in the manufacture of flexible film laminates for food packaging. This is a one-component, formaldehyde-free, all acrylic adhesive. It can be applied by conventional gravure cylinder coating technique." },
        { name: "FLEXBOND FP DRY LAM AEM 36", image: "/images/chemicals/1.png",description: "A waterborne acrylic adhesive designed for use in the manufacture of flexible film laminates of paper to aluminium foil, m-CPP & m-PET structures for food packaging. This is one-component, formaldehyde-free, all-acrylic adhesive. It can be applied by conventional gravure cylinder coating techniques." },
        { name: "FLEXBOND FP DRY LAM HR AEM 90", image: "/images/chemicals/1.png",description: "A single component water-based acrylic adhesive for manufacture of flexible film laminates of Paper to aluminium foil, m-CPP and m-PET structures with excellent heat resistance properties." },
        { name: "FLEXBOND FP two component Dry Lam HR AER with Flexcross FP two-component hardener AEK 3%", image: "/images/chemicals/1.png",description: "Two Component water - based acrylic adhesive for the manufacture of flexible film laminates of paper to PET or BOPP film & paper to aluminium foil, metallised film to paper with excellent heat resistance properties." },
        { name: "FLEXBOND FP DRY LAM AEM 36(H)", image: "/images/chemicals/1.png",description: "It is a waterborne acrylic adhesive used for the manufacture of flexible film laminates of paper to PET or BOPP film and paper to aluminium foil, metallised film to paper structures with high heat resistance properties. It can be used as single component or two component with Flexcross FP two component hardener VF/12K 3%." },
        { name: "FLEXBOND SF DRY LAM FB",image: "/images/chemicals/1.png", description: "A water based acrylic adhesive having excellent bond strength, mainly designed for lamination of films (Clear PET or BOPP, Matt BOPP) and metallised films to paper / duplex board for offset industries. It is recommended for dry bond lamination process." },
        { name: "FLEXBOND SF DRY LAM F2B",image: "/images/chemicals/1.png", description: "A water based acrylic adhesive designed primarily for lamination of films (clear PET or BOPP, Matt BOPP) and metallised or holo metallized film to paper/ duplex board for offset industries. It provides good dimensional stability on sheets after lamination. It is recommended for dry bond lamination process." },
        { name: "FLEXBOND FB DL 500", image: "/images/chemicals/1.png",description: "A water based acrylic designed primarily for lamination of films (clear PET or BOPP, Matt BOPP) and metallised films to paper/duplex board for offset industries. It provides excellent gloss and bond strength after lamination. This product is primarily recommended for dual metal rollers dry lamination machines." },
        { name: "FLEXBOND SF WET BOND LAM-HSW 55", image: "/images/chemicals/1.png",description: "A water based synthetic resin emulsion adhesive, primarily used for wet lamination of PET, BOPP films (clear or metallized) and matt BOPP to paper/duplex board." },
        { name: "FLEXBOND SF WET BOND LM 35", image: "/images/chemicals/1.png",description: "A water based synthetic adhesive used for wet lamination of clear BOPP and PVC film to paper/duplex board on manual or semi-automatic machine application. This product provides good gloss and bond strength after lamination with paperboard substrate." },
        { name: "FLEXBOND SF SIDE PASTING SPA", image: "/images/chemicals/1.png",description: "A water based synthetic resin emulsion adhesive designed mainly for carton making in side pasting application. It is recommended for BOPP, PET or metallised PET laminated with paperboard for side pasting application. It can be used on all standard wheel/roller applicators." },
        { name: "FLEXBOND SF WET LAM-1178", image: "/images/chemicals/1.png",description: "A water based synthetic adhesive designed mainly for side pasting and flap sealing application in carton box making. It is recommended for BOPP, PET or metallised PET laminated with paperboard for side pasting & flap sealing application. It is also suitable for inner side metallised film liner pasting in mono cartons and can be used on all standard nozzle applicators." },
        { name: "FLEXBOND 666", image: "/images/chemicals/1.png",description: "It is a water based high performance synthetic adhesive designed mainly for paper bag making in side , bottom and handle pasting applications. It gives excellent bonding with fast setting time, stability and flow behavior. It can be used on all standard wheel / roller applicators." },
        { name: "FLEXBOND SPA (LV)", image: "/images/chemicals/1.png",description: "It is a water-based synthetic adhesive designed mainly for paper bag and corrugation box making in side pasting application. It gives excellent bonding with fast setting time, stability and flow behavior. It is suitable for application by nozzle applicators." },
        { name: "FLEXBOND PB 40", image: "/images/chemicals/1.png",description: "It is a water based medium performance synthetic adhesive designed for paper bag making by roller coater for bottom pasting and by wheel roller in corrugation box side pasting application." },
        { name: "FLEXBOND WET LAM 1080", image: "/images/chemicals/1.png",description: "It is a water based medium performance synthetic adhesive for paper bag side pasting application by both nozzle & wheel applicator due to medium viscosity and for bottom and handle pasting by roller coater." },
        { name: "FLEXBOND SF-E Flute LAM –LF", image: "/images/chemicals/1.png",description: "A water-based synthetic resin emulsion adhesive designed mainly for lamination of flute board to paper/ duplex board. It can be applied by roller coater on fully/ semiautomatic machine." },
        { name: "FLEXBOND SF WET BOND HSW56", image: "/images/chemicals/1.png",description: "It is water-based synthetic resin emulsion adhesive used for wet lamination of paper to paper/duplex boards. It is recommended for rigid boxes applications. The product displays excellent bond strength. It can be applied by roller coater on fully automatic machine." }
      ]
    },
    ...
    "water-based-coatings": {
      ...
      overview: "Water-based coatings deliver high-performance surface enhancement with excellent gloss, scuff resistance, barrier properties, and compliance for food-contact applications.",
      sections: [
        { name: "FLEXCOAT SUPER GLOSS OPV-1000", image: "/images/chemicals/1.png",description: "waterborne copolymer emulsion for over printing of printed-paper and board. It is designed to give extremely super gloss properties with good flow & leveling on the substrate. It creates an even, smooth surface with good slip properties" },
        { name: "FLEXCOAT HIGH GLOSS OPV-1001 / FLEXCOAT HIGH GLOSS OPV 1011 (High Viscosity Version)", image: "/images/chemicals/1.png",description: "A waterborne copolymer emulsion for over printing of printed-paper and board. It creates an even, smooth surface with high gloss and high scuff properties." },
        { name: "FLEXCOAT GP GLOSS OPV-1002 / FLEXCOAT GP GLOSS OPV 1012 (High Viscosity Version)", image: "/images/chemicals/1.png",description: "A waterborne copolymer emulsion for over printing of printed-paper and board. It creates an even, smooth surface with good gloss and good scuff properties." },
        { name: "FLEXCOAT MATT OPV-1006", image: "/images/chemicals/1.png",description: "A waterborne copolymer emulsion for over printing of printed-paper and board. It is designed to give an even, smooth surface with excellent matt effect." },
        { name: "FLEXCOAT HIGH SCUFF WR OPV-1007",image: "/images/chemicals/1.png", description: "A waterborne copolymer emulsion for over printing of printed-paper and board. It provides excellent scuff resistance with good water resistance properties. It creates an even, smooth surface with good slip properties." },
