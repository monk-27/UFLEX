  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl poppins-800 text-center mb-4  text-[#117ABA] ">Our Vision & Mission</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="rounded-lg bg-gray-100 p-6 text-center transition-shadow hover:shadow-md ">
            <h3 className="text-2xl poppins-800 mb-4 text-[#117ABA] ">Vision</h3>
            ...
            <h3 className="text-2xl poppins-800 mb-4 text-[#117ABA] ">Mission</h3>
            <p className="text-gray-700 poppins-400 leading-relaxed text-lg">
