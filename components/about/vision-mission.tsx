  ...
  return (
    <section className="mt-[30px] px-4 py-0 text-center sm:mt-8  sm:py-10 md:px-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-start text-[24px] lato-700 text-[#173366] md:text-[42px]  ">Our Vision & Mission</h2>
        <p className="text-start lato-700 mt-0 text-[16px] text-[#181818] sm:mt-2 md:text-[24px]">
        ...
        <div className="max-w-7xl mx-auto w-full px-1 sm:px-0 mt-12 grid md:grid-cols-2 gap-8">
          <div className="rounded-lg bg-gray-100 p-6 text-center transition-shadow hover:shadow-md ">
            <h3 className="text-2xl lato-400 mb-4 text-[#173366] ">Vision</h3>
            ...
            <h3 className="text-2xl lato-400 mb-4 text-[#173366] ">Mission</h3>
            <p className="text-black lato-400 text-[16px] sm:text-[20px] leading-relaxed">
