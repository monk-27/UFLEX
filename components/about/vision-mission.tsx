  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className=" text-center text-[24px] manrope-600 text-[#117ABA] md:text-[42px] md:text-5xl ">Our Vision & Mission</h2>
        <p className="text-center manrope-600 text-gray-600 mb-12 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="rounded-lg bg-gray-100 p-6 text-center transition-shadow hover:shadow-md ">
            <h3 className="text-2xl manrope-800 mb-4 text-[#117ABA] ">Vision</h3>
            <p className="text-gray-700 manrope-400 leading-relaxed text-lg">
            ...
            <h3 className="text-2xl manrope-800 mb-4 text-[#117ABA] ">Mission</h3>
            <p className="text-gray-700 manrope-400 leading-relaxed text-lg">
