...
export default function BodMob() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="max-w-7xl mx-auto w-full px-4 sm:px-0 relative col-span-3 shadow-md lg:col-span-2"
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.7 }}
        viewport={{ once: true }}
      >
        <div className="max-w-7xl mx-auto w-full px-4 sm:px-0 relative flex items-center justify-center">
          {navReady ? (
            <Swiper
