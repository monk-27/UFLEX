...
//       { href: "/packaging-films-business", label: "Packaging Films Business" },
...
//   const [hoverMenu, setHoverMenu] = useState<string | null>(null) // which desktop dropdown is open
...
//   // Close desktop dropdowns when leaving the nav area
//   const closeHoverMenus = () => setHoverMenu(null)

//   return (
//     <header
//       className="site-header header-gradient sticky top-0 z-50 text-white shadow-sm py-4"
...
//                 {/* Desktop dropdown for "What We Do" */}
//                 {hasChildren && (
//                   <AnimatePresence>
//                     {isOpen && (
//                       <motion.div
...
//                                   href={child.href}
//                                   className={cn(
//                                     "block rounded-lg px-3 py-2 text-[14px] font-medium",
...
//           onClick={() => {
//             setOpen((v) => !v)
//             setMobileOpenMenu(null) // reset submenus when drawer toggles
//           }}
//           aria-expanded={open}
...
//               // For parents with children, clicking toggles submenu; long-press not needed.
//               if (hasChildren) {
//                 return (
...
//                       }
//                       className={cn(
//                         "w-full flex items-center justify-between rounded-md px-3 py-2 text-base font-medium transition",
//                         "text-white/90 hover:bg-white/10 hover:text-white",
...
//                       <span className={cn("transition-transform", isSubOpen && "rotate-180")}>
//                         ▾
//                       </span>
//                     </button>
