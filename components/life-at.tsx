...
//         viewport={{ once: true }}
//       >
//         <h2 className="text-[30px] leaders md:text-6xl">Life at UFlex</h2>
//         <h3 className="font-EB-extrabold mt-0 text-[16px] text-[#181818] sm:mt-2 md:text-3xl" style={{ lineHeight: "124%" }}>
...
//           >
//             <h3 className="font-EB-extrabold mb-3 text-[18px] text-[#181818] md:text-2xl">
//               {module.title}
//             </h3>
...
//                   <h4 className="orelega-one-regular text-white text-2xl md:text-3xl drop-shadow-[0_1px_1px_rgba(0,0,0,0.6)]">
//                     {module.title}
//                   </h4>
...
//                 <div className="relative">
//                   <h4 className="font-EB-extrabold text-white text-lg">{module.title}</h4>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <h2 className="text-[30px] poppins-800 text-3xl text-[#255994] sm:text-6xl">Life at UFlex</h2>
        <h3
