...
export default function SustainabilityCarousel() {
  ...
  return (
    <section
  className="w-full bg-cover bg-center pt-12 md:pt-16  lg:min-h-[400px] pb-12 md:pb-16 lg:pb-20"
  style={{ backgroundImage: "url('/images/hall/9.png')" }}
>


      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr] items-start md:items-center gap-12">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full h-[200px] sm:h-[240px] md:h-[280px] overflow-hidden rounded-md">
