  ...
  return (
    <section className="relative bg-white pt-12">
      <div className="mx-auto max-w-7xl px-6 text-center">
        <h2 className="text-[24px] lato-600 text-[#117ABA] md:text-[28px] ">People’s philosophy</h2>
        <p className="text-center lato-400 mt-1  text-gray-500 md:text-lg">
                ...
                <div className="block h-full">
                  <div className="group flex h-full flex-col overflow-hidden rounded-sm bg-gray-100 shadow-sm hover:shadow-md transition">
                    ...
                    <div className="relative p-5 pl-8">
                      ...
                      <p className="mt-3 lato-400 text-sm md:text-base leading-relaxed text-black">
                        {card.desc}
                      </p>
                    </div>
                  </div>
